  ...
  return (
    <section className="min-h-screen bg-white hero-grid relative flex flex-col items-center justify-center px-6">
      <div className="max-w-[1100px] mx-auto w-full flex flex-col items-center text-center">
        ...
        <p className="text-[18px] text-gray-400 font-normal max-w-lg mb-16 leading-relaxed">
        ...
        <div className="flex items-center gap-12 sm:gap-16 mb-16">
          {features.map((f) => (
            <div key={f.label} className="flex flex-col items-center gap-2.5">
              ...
              <span className="text-[14px] font-medium text-gray-400">{f.label}</span>
            </div>
          ))}
        </div>
        ...
        <button
          ...
          className="bg-gray-900 hover:bg-gray-800 text-white font-medium text-[14px] px-7 py-3 rounded-xl transition-all duration-200 cursor-pointer flex items-center gap-2.5 hover:-translate-y-0.5"
        >
          Try the Demo
